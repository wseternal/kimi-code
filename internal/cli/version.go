...
//
//	go build -ldflags "-X github.com/visdomtech/kimi-code/internal/cli.Version=0.1.0"
var Version = "dev"

// GitSHA is the short git commit SHA. Set at build time via -ldflags:
//
//	go build -ldflags "-X github.com/visdomtech/kimi-code/internal/cli.GitSHA=$(git rev-parse --short HEAD)"
var GitSHA = ""
