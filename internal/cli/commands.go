...
func (r *CommandRegistry) registerDefaults() {
	...
	// Agent commands
	r.Register(SlashCommandDef{Name: "goal", Desc: "Manage autonomous goals", Usage: "/goal <text>|status|pause|resume|cancel|next <obj>|next manage|next remove <id>|next clear", Group: "agent"})
